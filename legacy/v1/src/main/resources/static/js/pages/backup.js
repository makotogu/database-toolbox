        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form id="restore-form" class="form">
                    <div class="form-section">
                        <div class="section-title">恢复目标</div>
                        <div class="grid-3">
                    ...
                    <div class="notice warn">恢复会优先读取 ZIP 内 manifest 的分隔符、字符集、Quote 和 Escape 配置；旧备份包缺少 manifest 字段时使用系统默认。</div>
