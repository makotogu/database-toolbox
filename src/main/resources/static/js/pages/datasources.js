    ...
    root.innerHTML = `
        ...
        <div class="grid-2">
            <section class="panel">
                ...
                <div class="panel-body">${formHtml(editing)}</div>
            </section>
            <section class="panel">
                <div class="panel-header"><h2 class="panel-title">已配置数据源</h2></div>
...
function formHtml(item) {
    ...
    return `
        <form id="datasource-form" class="form">
            ...
            <div class="field"><label>连接参数（key=value，每行一个）</label><textarea class="textarea" name="params" placeholder="connectTimeout=5000&#10;driverClassName=com.huawei.gaussdb.jdbc.Driver&#10;urlPrefix=jdbc:gaussdb://">${escapeHtml(params)}</textarea></div>
